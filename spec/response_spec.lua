...
describe('Response', function()
    ...
    describe('send failures', function ()
        ...
        it('closed', function ()
            ...
            local s1 = Error.pcall(r.append_body, r, '       ')
            assert(s1)
            local s2, err = Error.pcall(r.append_body, r, 'closed')
            assert(not s2)
            assert(err.msg == 'Attempt to send on closed socket', string.format('%s', err))
